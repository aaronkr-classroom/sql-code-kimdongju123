...
장점:검색 성능을 향상시켜 빠른 데이터 조회가 가능하다.
단점:인덱스를 많이 생성하면 저장 공간을 차지하며, 데이터 추가, 삭제, 수정 시 성능 저하가 발생할 수 있습니다.


**18 인덱스를 사용하는 것이 바람직한 경우와 그렇지 않은 경우를 구분하여 설명하시오.**

바람직한 경우: 검색이 빈번하게 발생하는 경우.
바람직하지 않은 경우: 데이터 수정, 삭제, 추가 작업이 빈번하게 발생하는 경우.
